 ...
 * {@link android.support.v7.widget.RecyclerView} and {@link ViewPager} to start transition between them.
 * But when {@link ViewPager} is scrolled we may also need to scroll {@link android.support.v7.widget.RecyclerView} to reveal
